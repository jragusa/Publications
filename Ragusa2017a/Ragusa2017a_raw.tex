...
{\smallskip{\footnotesize%
  ...
  \textsuperscript{2} Texas Tech University, Department of Geosciences, 1200 Memorial Circle, Lubbock, TX 79409, USA\par
  \addvspace{\medskipamount}
  \textsuperscript{3} Universidad del Valle, Escuela de Ingeniería Civil y Geomática, Cali, Colombia\par
  \medskip
  \normalsize{International Journal of Earth Sciences, 106(8):2619-2651, doi: \href{https://doi.org/10.1007/s00531-017-1474-9}{10.1007/s00531-017-1474-9}}
  \medskip
}}
\end{flushleft}
...
\afterpage{
	\begin{table}
		 \centering
		 \small
		 \caption{Additional key indices for the framework composition and heavy-minerals. Mineral abbreviations are based on the compilation of \cite{Whitney2010} excepted: Qms = single monocristalline quartz, Qps = non tectonised polycrystalline quartz, QpT = tectonised polycrystalline quartz, Ks = single K-feldspar, Ps = single plagioclase.}
		 \label{tab:Table1}
...
\afterpage{
	\begin{table}
		 \centering
		 \small
		 \caption{Recounted heavy mineral raw data from \SIrange{63}{400}{\micro\meter} fraction from \cite{Ragusa2009}. Mineral abbreviations are based on the compilation of \cite{Whitney2010} and similar to Table~\ref{tab:Table2}.}
		 \label{tab:Table1}
		 \renewcommand{\arraystretch}{1.5}
		 \begin{tabular}{p{0.4\textwidth}l}
			 \hline
			 Sample & Location & Petrofacies & HMC & tHMC & Ap & Chl & Grt & Bt & Ms & Rt & St & Ttn & Tur & Zrn & \&tHM & Opaque & Other & Total \\
			 \hline
			 F2a & Fillinges quarry & Quartzose & 0.367 & 0.125 & 89 & 5 & 7 &32&1&16&10&12&20&50&2&541&80&829 \\
			 F2b&Fillinges quarry &Quartzose&0.353&0.135&30&19&10&43&2&9&6&7&43&50&1&520&82&788 \\
			 F3b
Fillinges quarry
Quartzose
0.238
...
The Quartzose petrofacies essentially contains abundant tourmaline reflected by lower ATi \citep{Morton1994} and higher ZTR indices (Fig.~\ref{fig:Fig12}; Table~\ref{tab:Table2}). The garnet content is low, as emphasised by the low GZi index (Fig.~\ref{fig:Fig12}; Table~\ref{tab:Table2}; \citealp{Morton1994}). The scarce K-rich volcanic glass confirms the rhyolitic source described in Fig.~\ref{fig:Fig11}g. A large variation in mica distribution and the occurrence of biotite characterise the Quartzose petrofacies.\par
Preliminary single-grain analysis on garnets identified almandine and almandine-pyrope solid solution (mean = 86.09~\%) as dominant phases (Fig.~\ref{fig:Fig15}a). Subordinate grains are almandine-pyrope-grossular and almandine-spessartine solid solutions (mean = 6.95~\%). Less than 10~\% of garnets grains were undetermined. Moreover, the Quartzose petrofacies shows the schorl-dominated assemblage among tourmaline grains (Fig.~\ref{fig:Fig16}).
...
The Feldspathic petrofacies is characterised by a high content in garnet and an elevated GZi index in the \SIrange{63}{125}{\micro\meter} fraction (Fig.~\ref{fig:Fig12}, Table~\ref{tab:Table2}). Consequently, the ATi index is high and the ZTR index is low (Fig.~\ref{fig:Fig12}; Table~\ref{tab:Table2}). The distribution of micas is relatively constant in the Feldspathic petrofacies and is dominated by chlorite (Fig.~\ref{fig:Fig13}). Single grain analysis on garnet identified almandine-pyrope-grossular and almandine-spessartine solid solutions, similar to the assemblages found in the Quartzose petrofacies. As for the latter, the tourmaline assemblage is dominated by schorl (Fig.~\ref{fig:Fig16}).
